BEGIN;
    ...
    CREATE MATERIALIZED VIEW here_trip_v3
    ...
    CREATE INDEX idx_location_here_trip_v3 ON here_trip_v3 USING gist(location);
    CREATE INDEX idx_service_id_here_trip_v3 ON here_trip_v3 (service_id);
    CREATE UNIQUE INDEX idx_unique_here_trip_v3 ON here_trip_v3 (id);

    DROP  MATERIALIZED VIEW here_trip;
    ALTER MATERIALIZED VIEW here_trip_v3 RENAME TO here_trip;

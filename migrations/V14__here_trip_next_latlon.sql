BEGIN;
    CREATE MATERIALIZED VIEW here_trip_v5
    ...
    CREATE INDEX idx_location_here_trip_v5 ON here_trip_v5 USING gist(location);
    CREATE INDEX idx_service_id_here_trip_v5 ON here_trip_v5 (service_id);
    CREATE UNIQUE INDEX idx_unique_here_trip_v5 ON here_trip_v5 (id);

    DROP  MATERIALIZED VIEW IF EXISTS here_trip;
    ALTER MATERIALIZED VIEW here_trip_v5 RENAME TO here_trip;
COMMIT;

BEGIN;
    CREATE MATERIALIZED VIEW here_trip_v7
    ...
    SELECT
        ...
        COALESCE(route.route_short_name, '') AS route_short_name,
        COALESCE(route.route_long_name, '')  AS route_long_name,
    ...
    CREATE INDEX idx_location_here_trip_v7 ON here_trip_v7 USING gist(location);
    CREATE INDEX idx_service_id_here_trip_v7 ON here_trip_v7 (service_id);
    CREATE UNIQUE INDEX idx_unique_here_trip_v7 ON here_trip_v7 (id);

    DROP  MATERIALIZED VIEW IF EXISTS here_trip;
    ALTER MATERIALIZED VIEW here_trip_v7 RENAME TO here_trip;
COMMIT;
